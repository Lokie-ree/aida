...
import { Trash2, CheckCircle, Copy, ThumbsUp, ThumbsDown } from "lucide-react";
...
export function PromptLibrary({ onSelectPrompt }: PromptLibraryProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 overflow-y-auto h-full p-1">
      {prompts.map((prompt) => (
